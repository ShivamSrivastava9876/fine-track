...
const columns = [
  ...
  { id: "category", label: "कैटेगरीचे नाव", minWidth: 100 },
  { id: "productType", label: "प्रोडक्ट प्रकारचे नाव", minWidth: 600 },
      ...
      {updateSuccess && (
        ...
        >
          <strong className="font-bold">
            प्रोडक्ट प्रकारचे अपडेट पूर्ण झाले
          </strong>
          <button
