  ...
  return (
    <>
      ...
      <div id="addProductType" className="flex justify-center m-8 relative">
        ...
        >
          <div className="mb-4">
            <h2 className=" text-[#0a0a0a] text-center font-normal text-base text-16px h-4 m-4 w-10.0625">
              Add product type
            </h2>
          </div>
          <div className="grid md:grid-cols-1 gap-1">
            <div onClick={handleCategory} class="relative inline-block cursor-pointer text-left md:w-21.375 mb-4">
