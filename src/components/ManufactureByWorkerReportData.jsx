...
import { getManufacturingByWorkerData, getWorkerReportAsync, getWorkerReportList, getYearlyManufacturingReportDataAsync, getYearlyReportList } from "../redux/slice/report/reportSlice";
...
export default function ManufactureByWorkerReportData() {
    ...
    return (
        <div>
            <h1 className="text-2xl mx-4 mb-4 font-bold">Report of manufacturing by selected worker</h1>
