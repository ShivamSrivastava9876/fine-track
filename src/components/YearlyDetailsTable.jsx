...
export default function YearlyDetailsTables() {
  ...
  const handleYearlyOrderReportSearch = (e) => {
    e.preventDefault();
    dispatch(searchYearlyOrderReportAsync(searchParameter)).then((result) => {
      if (searchYearlyOrderReportAsync.fulfilled.match(result)) {
        // setSearchParameter("");
      }
    })
  }
  ...
  const downloadExcel = (data) => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "YearlyOrderReport");
    XLSX.writeFile(workbook, "yearly_order_report.xlsx");
  }
      ...
      <div className="flex items-center justify-between flex-wrap w-full mb-4">
        ...
        <div className="flex flex-wrap">
          ...
          <form onSubmit={(e) => handleYearlyOrderReportSearch(e)} className="flex items-center m-2 md:w-80 border-2 border-solid border-gray-300 rounded-full px-4 py-2">
            ...
            <div className="ml-2">
              <Image
                onClick={handleYearlyOrderReportSearch}
                src={SearchIcon}
                alt="search-icon"
