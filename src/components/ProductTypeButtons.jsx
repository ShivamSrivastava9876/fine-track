  ...
  return (
    <div className="flex items-center justify-between w-full mb-8">
      ...
      <div className="flex items-center space-x-4 relative">
        ...
        {/* Button 2 */}
        <button
          className={`flex items-center px-4 py-2 bg-[#DB8A4D] text-white rounded-xl shadow transition-transform duration-300 transform ${addProductType ? "invisible" : ""
            }`}
      ...
      {/* User Title */}
      <h1 className="text-2xl mx-4 font-bold">Product type</h1>

      {/* Right-hand side Search Box */}
      <form onSubmit={(e) => handleProductTypeSearch(e)} className="flex items-center w-96 border-2 border-solid border-gray-300 rounded-full px-4 py-2">
        <input
          type="search"
          placeholder="Search"
