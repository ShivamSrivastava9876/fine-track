...
import {
  getConfirmOrderAsync,
  getConfirmOrderData,
} from "@/redux/slice/order/orderSlice";
import {
  getManufacturingByWorkerReportAsync,
  getOrderByProductReportAsync,
  getProductReportAsync,
  getProductReportList,
  getWorkerReportAsync,
  getWorkerReportList,
  getYearlyManufacturingReportDataAsync,
  getYearlyReportList,
  searchProductReportAsync,
} from "../redux/slice/report/reportSlice";

const columns = [
  { id: "productId", label: "प्रोडक्टची आयडी", minWidth: 100 },
  { id: "productName", label: "प्रोडक्ट", minWidth: 250 },
  { id: "category", label: "कैटेगरी", minWidth: 100 },
  { id: "productType", label: "प्रोडक्टचा प्रकार", minWidth: 100 },
  { id: "orderCount", label: "ऑर्डर मोजणी", minWidth: 80 },
];
  ...
  return (
    <div>
      <div className="flex items-center justify-between flex-wrap w-full mb-4">
        <h1 className="text-2xl mx-4 mb-1 font-bold">प्रोडक्ट अहवाल</h1>
        ...
        <div className="flex flex-wrap">
          ...
          <form
            onSubmit={(e) => handleProductReportSearch(e)}
            className="flex items-center m-2 md:w-80 border-2 border-solid border-gray-300 rounded-full px-4 py-2"
          >
            <input
              type="search"
              placeholder="शोधा"
                          ...
                          >
                            {column.id === "orderCount" ? (
                              <div className="text-blue-500 font-semibold">
                                <Link href={`/orderByProductReport/${row.id}`}>
                                  {value || "0"}
                                </Link>
                              </div>
