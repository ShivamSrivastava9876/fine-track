...
import { getDailyManufacturingReportDataAsync, getDailyReportList, getWeeklyManufacturingReportDataAsync, getWeeklyReportList, searchWeeklyManufacturingReportAsync } from "../redux/slice/report/reportSlice";
...
export default function WeeklyManufacturingDetailsTable() {
    ...
    const handleWeeklyManufacturingReportSearch = (e) => {
        e.preventDefault();
        dispatch(searchWeeklyManufacturingReportAsync(searchParameter)).then((result) => {
            if (searchWeeklyManufacturingReportAsync.fulfilled.match(result)) {
                // setSearchParameter("");
            }
        })
    }
    ...
    const downloadExcel = (data) => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "WeeklyManufacturingReport");
        XLSX.writeFile(workbook, "weekly_manufacturing_report.xlsx");
    }
    ...
    return (
        <div>
            <div className="flex items-center justify-between flex-wrap w-full mb-4">
                <h1 className="text-2xl mx-4 mb-4 font-bold">साप्ताहिक उत्पादन अहवाल</h1>
                <div className="flex flex-wrap">
                    ...
                    <form onSubmit={(e) => handleWeeklyManufacturingReportSearch(e)} className="flex items-center m-2 md:w-80 border-2 border-solid border-gray-300 rounded-full px-4 py-2">
                        <input
                            type="search"
                            placeholder="शोधा"
                        ...
                        <div className="ml-2">
                            <Image
                                onClick={handleWeeklyManufacturingReportSearch}
                                src={SearchIcon}
                                alt="search-icon"
