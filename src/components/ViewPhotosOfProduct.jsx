    ...
    return (
        <div>
            ...
            <div className="flex justify-center items-center fixed bottom-2 top-2 right-5 left-5 z-50">
                ...
                <div className="p-8 rounded shadow-md flex flex-col justify-start overflow-y-scroll scroll-smooth no-scrollbar h-full w-auto bg-white border border-blue-500">
