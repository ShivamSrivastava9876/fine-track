...
function ReportBarGraph() {
  ...
  return (
    <div>
      {/* Bar chart */}
      <h1 className="w-[150px] mx-auto mb-5 flex justify-center text-2xl font-bold ">
        ऑर्डर अहवाल
      </h1>
      <div className="flex justify-center space-x-1 ">
        <button
          onClick={handleDailyData}
          className={`px-4 py-2 ${
            active === "daily" ? "bg-orange-800" : "bg-[#DB8A4D]"
          }  hover:bg-orange-800 border border-black text-white rounded`}
        >
          दररोज
        </button>
        <button
          ...
          className={`px-4 py-2 ${
            active === "weekly" ? "bg-orange-800" : "bg-[#DB8A4D]"
          }  hover:bg-orange-800 border border-black text-white rounded`}
        >
          साप्ताहिक
        </button>
        <button
          ...
          className={`px-4 py-2 ${
            active === "monthly" ? "bg-orange-800" : "bg-[#DB8A4D]"
          }  hover:bg-orange-800 border border-black text-white rounded`}
        >
          मासिक
        </button>
        <button
          ...
          className={`px-4 py-2 ${
            active === "yearly" ? "bg-orange-800" : "bg-[#DB8A4D]"
          }  hover:bg-orange-800 border border-black text-white rounded`}
        >
          वार्षिक
        </button>
      </div>
      <h1 className="w-auto mx-auto m-5 flex justify-center text-s font-bold ">
        {title} अहवाल{" "}
      </h1>
      <div className="w-full md:w-4/5 mx-auto mt-4 flex flex-col">
        ...
        <Link
          href={`/${active}Reports`}
          className="mt-3 text-blue-500 hover:underline ml-auto"
        >
          अधिक पहा ...
        </Link>
      </div>
